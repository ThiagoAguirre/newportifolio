    ...
    <section id="contact" className="relative z-10 py-20 px-4 max-w-6xl mx-auto">
        ...
        <div className="space-y-8">
          <div>
            <h3 className="text-2xl font-bold text-white mb-4">
              {t('Pronto para seu próximo projeto?')}
            </h3>
            <p className="text-white/70 text-lg leading-relaxed">
              {t('Estou sempre interessado em novos desafios e oportunidades de colaboração. Vamos criar algo incrível juntos!')}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-white font-semibold">{t('GitHub')}</p>
          ...
          <form className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder={t('Conte-me sobre seu projeto...')}
              ></textarea>
            </div>
      ...
      <div className="text-center mt-16 pt-8 border-t border-white/10">
        <p className="text-white/60">
          {t('© 2024 Thiago Aguirre. Desenvolvido com React e Tailwind CSS.')}
        </p>
      </div>
    </section>
  );
